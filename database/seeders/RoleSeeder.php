...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
       ...
       Permission::create(['name'=>'productos.view'])->syncRoles([$role1,$role2]);
       ...
       Permission::create(['name'=>'categorias.view'])->syncRoles([$role1,$role2]);
       ...
       Permission::create(['name'=>'pedidos.view'])->syncRoles([$role1,$role2]);
