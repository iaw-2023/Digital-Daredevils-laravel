...
Route::get('/pedidos/{id}', [ApiController::class, 'pedidosUsuario'])->middleware('auth0');;
Route::get('/detallesPedido/{id}', [ApiController::class, 'detallesPedido'])->middleware('auth0');;
Route::post('/pedidos',[ApiController::class,'storePedido'])->middleware('auth0');